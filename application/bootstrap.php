...
if (PHP_SAPI === 'cli') //Kohana::$is_cli
{
	Kohana::$environment = Kohana::PRODUCTION;
}
else
{
	Kohana::$environment = (strpos($_SERVER['SERVER_NAME'], 'websumy') !== FALSE) ?
		(
		! isset($_GET['debug23']) ?
			Kohana::PRODUCTION
			: Kohana::TESTING
...
Cookie::$salt = '845hfjhjkhjk687rtsa51Gyj';
